...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'account_account', (
            ...
            ('real_name', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ...
            ('image_thumbnail', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True)),
        ...
        db.create_table(u'account_emailconfirmation', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 24, 0, 0))),
