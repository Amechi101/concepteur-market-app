...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.real_name'
        db.add_column(u'account_account', 'real_name',
        ...
        # Adding field 'Account.image_thumbnail'
        db.add_column(u'account_account', 'image_thumbnail',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.real_name'
        db.delete_column(u'account_account', 'real_name')
        ...
        # Deleting field 'Account.image_thumbnail'
        db.delete_column(u'account_account', 'image_thumbnail')
    ...
    models = {
        u'account.account': {
            ...
            'image_thumbnail': ('imagekit.models.fields.ProcessedImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'account.emailconfirmation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
