...
class SettingsForm(forms.Form):
    ...
    email = forms.EmailField(label=_("Email"), widget=forms.TextInput(attrs={'id': 'email_settings'}),required=True)
    real_name=forms.CharField(max_length=50, widget=forms.TextInput(attrs={'placeholder': 'Real Name','required':True}))
    birthday=forms.DateField(label=_("Birthdate"),widget=forms.TextInput(attrs={'placeholder': '19YY-MM-DD','required':False}))
