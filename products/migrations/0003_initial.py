...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'products_product', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('color_name', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('size_types', self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True)),
            ...
            ('product_tags', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('novelty', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('product_website', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255)),
            ('uploaded_by', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('uploaded_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('designer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Designer'])),
            ('boutique', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Boutique'])),
