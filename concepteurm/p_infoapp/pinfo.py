...
# # import #mydbsql or rbmds or something from the google documentation

# #render response with views 
# from django.conf import settings
# from apps import apps_defaults

# settings.configure(default_settings=apps_defaults, DEBUG=True)

#figure out a way to make one big dictionary to extract info

agrv =('models')
models = {'name' : 'Amechi', 'address': '113 Liberty Blvd' ,'email': 'amechiegbe@gmail.com'}


for val in models.items():
    def models():
        if len(models) == 0:
            print ','.join(models)
